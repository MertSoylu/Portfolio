...
const GooeyNav = (props) => {
  ...
  const activeIndex = props.activeIndex !== undefined ? props.activeIndex : internalIndex;
  ...
  useEffect(() => {
    if (props.activeIndex !== undefined) {
      setInternalIndex(props.activeIndex);
    }
  }, [props.activeIndex]);
  ...
  useEffect(() => {
    ...
    if (activeLi) {
      ...
      // Only add 'active' class if not already set (avoid re-triggering animation)
    ...
    <>
      ...
      <style>
        {`
          ...
          .effect.filter {
            /* Clean pill indicator - no gooey filter */
          }
