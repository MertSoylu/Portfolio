...
export const ScrollStackItem = ({ children, itemClassName = '' }) => (
  <div
    className={`scroll-stack-card relative w-full min-h-[280px] h-80 my-8 p-6 sm:p-12 rounded-[40px] shadow-[0_0_30px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  const setupScrollListener = useCallback(() => {
    if (useWindowScroll) {
      // Use native scroll + rAF for smooth updates without hijacking scroll
      const onScroll = () => {
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-[5vh] px-4 sm:px-8 lg:px-20 pb-[3rem] sm:pb-[4rem]">
        {children}
